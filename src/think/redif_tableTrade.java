...
public class redif_tableTrade 
{
	public static void main(String args[]) throws InterruptedException
	{
		...
		WebElement trade = driver.findElement(By.xpath("//table[@class='dataTable']"));
		List<WebElement> allrows = trade.findElements(By.tagName("tr"));
